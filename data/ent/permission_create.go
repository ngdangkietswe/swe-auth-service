...
func (pc *PermissionCreate) SetActionID(u uuid.UUID) *PermissionCreate {
...
func (pc *PermissionCreate) AddUsersPermissionIDs(ids ...uuid.UUID) *PermissionCreate {
	pc.mutation.AddUsersPermissionIDs(ids...)
	return pc
}

// AddUsersPermissions adds the "users_permissions" edges to the UsersPermission entity.
func (pc *PermissionCreate) AddUsersPermissions(u ...*UsersPermission) *PermissionCreate {
	ids := make([]uuid.UUID, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
	return pc.AddUsersPermissionIDs(ids...)
}
