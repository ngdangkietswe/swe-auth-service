...
type IAuthService interface {
	...
	ForgotPassword(ctx context.Context, req *auth.ForgotPasswordReq) (*common.EmptyResp, error)
	ResetPassword(ctx context.Context, req *auth.ResetPasswordReq) (*common.EmptyResp, error)
}
